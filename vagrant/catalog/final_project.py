...
def newRestaurant():
    ...
    if request.method == 'POST':
        newMenuItem = Restaurant(name=request.form['name'], user_id=login_session['user_id'])
...
def newMenuItem(restaurant_id):
    ...
    if request.method == 'POST':
        newMenuItem = MenuItem(name=request.form['name'], description=request.form['description'],
                               course="Entree", price=request.form['price'], restaurant_id=restaurant_id, user_id=restaurant.user_id)
        session.add(newMenuItem)
        session.commit()
        flash("NEW MENU ITEM CREATED!!")
